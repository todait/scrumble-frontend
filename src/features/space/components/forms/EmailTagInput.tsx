...
export const EmailTagInput: React.FC<EmailTagInputProps> = ({
  ...
  return (
    <div className="w-full">
      <div 
        className={`w-full min-h-[60px] px-5 py-4 bg-white border rounded-xl flex flex-wrap items-start gap-2 font-pretendard ${
      ...
      >
        ...
        <div className="flex items-center flex-1 min-w-[200px] min-h-[28px]">
          <input
            type="text"
            value={inputValue}
            ...
            className="flex-1 outline-none text-[18px] font-normal text-[#181818] placeholder-[#181818]/60 bg-transparent"
          />
        </div>
      </div>
      {hasError && (
